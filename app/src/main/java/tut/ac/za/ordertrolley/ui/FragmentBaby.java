...
public class FragmentBaby extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final Query query = db.orderByChild("catergory").equalTo("baby");
        ...
        adapter = new FirebaseRecyclerAdapter<Item,ViewItemHolder>(Item.class,R.layout.item_view,ViewItemHolder.class,query) {
            @Override
            protected void populateViewHolder(ViewItemHolder viewHolder, final Item model, final int position) {
